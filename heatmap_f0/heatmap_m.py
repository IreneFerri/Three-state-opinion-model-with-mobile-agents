...
#                     vmax=zmax, vmin=zmin)
CS = plt.contourf(xi, yi, zi, interpolation, cmap='seismic',
                     vmax=zmax, vmin=zmin)
# COLORBAR ----------------------
cb = plt.colorbar(CS)
...
plt.yticks(rotation = 'horizontal', fontsize = tick_size)
plt.xticks([0.9, 1.0, 1.1, 1.2], rotation = 'horizontal', fontsize = tick_size)
