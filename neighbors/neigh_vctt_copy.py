...
R =  1.05001*d_c #distance criteria: what each node "sees"
nsteps = 2
#nsteps = 50*N
vmin = 0.1 #initial velocity module
vmax = 0.12
...
prob_file = open('second_neigh_RW'+'_N'+str(N)+'_a'+str(alpha)+'_T'+str(temp)+'_v'+str(vmin)+'.csv','w')
