...
velocities = np.array([0.05, 0.07, 0.1, 0.13, 0.15, 0.18, 0.2, 0.25, 0.3, 0.35, 0.4, 0.41, 0.45])
#velocities = np.array([0.1, 0.15, 0.35])
#velocities = np.array([0.1, 0.15])
...
ax.text(2, 6000, r'$\alpha = $'+str(alpha), fontsize=label_size)
