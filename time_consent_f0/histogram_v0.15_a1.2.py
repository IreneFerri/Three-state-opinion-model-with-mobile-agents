...
intervalos = range(0, max(temps_partial) + 2, 2) #calculamos los extremos de los intervalos
...
plt.text(29, 10, 'd)', fontsize=label_size)
plt.text(40, 8, r'$v = $'+str(v), fontsize=label_size)
plt.text(40, 7, r'$\alpha = $'+str(alpha), fontsize=label_size)
