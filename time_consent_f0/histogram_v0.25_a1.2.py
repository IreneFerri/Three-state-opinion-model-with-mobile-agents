...
intervalos = range(0, max(temps_partial) + 2, 1) #calculamos los extremos de los intervalos

inter_ticks = range(0, max(temps_partial) + 2, 5) 
...
plt.text(25, 10, 'b)', fontsize=label_size)
plt.text(19, 6.5, r'$v = $'+str(v), fontsize=label_size)
plt.text(19, 5, r'$\alpha = $'+str(alpha), fontsize=label_size)
