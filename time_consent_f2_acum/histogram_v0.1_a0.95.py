...
intervalos = range(0,  inter_max+ 2, 3) #calculamos los extremos de los intervalos

inter_ticks = range(0, inter_max + 2, 10) 
...
plt.text(4, 14, 'c)', fontsize=label_size)
plt.text(40, 8, r'$v = $'+str(v), fontsize=label_size)
plt.text(40, 6, r'$\alpha = $'+str(alpha), fontsize=label_size)
