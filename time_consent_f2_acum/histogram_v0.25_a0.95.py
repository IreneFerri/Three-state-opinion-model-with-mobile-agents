...
intervalos = range(0,  inter_max+ 2, 4) #calculamos los extremos de los intervalos

inter_ticks = range(0, inter_max + 2, 20) 
...
plt.text(20, 24, 'a)', fontsize=label_size)
plt.text(52, 14, r'$v = $'+str(v), fontsize=label_size)
plt.text(52, 11, r'$\alpha = $'+str(alpha), fontsize=label_size)
