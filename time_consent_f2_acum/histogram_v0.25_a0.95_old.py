...
intervalos = range(0, max(temps_partial) + 2, 200) #calculamos los extremos de los intervalos

inter_ticks = range(0, max(temps_partial) + 2, 1000) 
...
plt.text(2500, 80, 'a)', fontsize=label_size)
plt.text(4000, 65, r'$v = $'+str(v), fontsize=label_size)
plt.text(4000, 58, r'$\alpha = $'+str(alpha), fontsize=label_size)
