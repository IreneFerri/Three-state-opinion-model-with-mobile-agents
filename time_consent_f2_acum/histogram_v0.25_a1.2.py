...
intervalos = range(0,  inter_max+ 2, 7) #calculamos los extremos de los intervalos

inter_ticks = range(0, inter_max + 2, 40) 
...
plt.text(40, 75, 'b)', fontsize=label_size)
plt.text(95, 45, r'$v = $'+str(v), fontsize=label_size)
plt.text(95, 35, r'$\alpha = $'+str(alpha), fontsize=label_size)
