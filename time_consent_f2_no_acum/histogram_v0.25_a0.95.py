...
intervalos = range(0, max(temps_polar) + 2, 2) #calculamos los extremos de los intervalos

inter_ticks = range(0, max(temps_polar) + 2, 10) 
...
plt.text(40, 10, 'a)', fontsize=label_size)
plt.text(40, 8.2, r'$v = $'+str(v), fontsize=label_size)
plt.text(40, 6.8, r'$\alpha = $'+str(alpha), fontsize=label_size)
