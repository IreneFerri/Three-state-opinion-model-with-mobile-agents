...
intervalos = range(0, max(temps_neutral) + 2, 1) #calculamos los extremos de los intervalos

inter_ticks = range(0, max(temps_neutral) + 2, 2) 
...
plt.text(6, 32, 'b)', fontsize=label_size)
plt.text(6, 26, r'$v = $'+str(v), fontsize=label_size)
plt.text(6, 22, r'$\alpha = $'+str(alpha), fontsize=label_size)
